...
This is the first significant program I have created on my own that has not been some example or exercise, so I'm very
...
It is important to note that:
    ...
    3) The main file of this program is named "together.py" (so named, because that's where I brought together several
    snippets of code from other files)

    4) hello.py is the start of the UI that I'm trying to build for this program. It is nowhere near completion, so
